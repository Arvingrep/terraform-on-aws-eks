...
aws eks --region ap-southeast-1 update-kubeconfig --name arvin-dev-eksdemo1 --profile eksadmin1
...
aws eks --region ap-southeast-1 update-kubeconfig --name arvin-dev-eksdemo1 
[or]
aws eks --region ap-southeast-1 update-kubeconfig --name arvin-dev-eksdemo1 --profile default
